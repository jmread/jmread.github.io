...
* link:"https://drive.google.com/file/d/0B-MBtJlIZA-BWkVVYkJETEtZckk/view?pref=2&pli=1"[Demo Animation] (the captions explain what is going on)
...
==== Modelling tree growth in Scotts pine
