...
link:http:http://perso.telecom-paristech.fr/~jread/papers/Read,%20Puurula,%20Bifet%20-%20Multi-label%20Classification%20with%20Meta-Labels.pdf[Multi-label
...
link:http:http://perso.telecom-paristech.fr/~jread/papers/Read,%20Bifet%20-%20Data%20Stream%20Classification%20using%20Random%20Feature%20Functions%20and%20Novel%20Method%20Combinations.pdf[Data Stream Classification using Random Feature Functions and Novel Method Combinations].  
...
Jesse Read, Bernhard Pfahringer, Geoff Holmes.
link:http:http://perso.telecom-paristech.fr/~jread/papers/synth.pdf[Generating Synthetic Multi-label Data Streams].
