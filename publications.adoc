...
See me also on link:http://scholar.google.com/citations?user=4gNCRFAAAAAJ&hl=en&oi=ao[Google Scholar].

=== Journals

Roelant A. Stegmann, Indrė Žliobaitė, Tuukka Tolvanen, Jaakko Hollmén, Jesse Read. link:http://dx.doi.org/10.1002/widm.1237[A survey of evaluation methods for personal route and destination prediction from mobility traces]. _Wiley Interdisciplinary Reviews: Data Mining and Knowledge Discovery_, e1237. 2017.
...
Jacob Montiel, Jesse Read,  Albert, Talel Abdessalem. 
*Scalable Model-based Cascaded Imputation of Missing Data*. 
(To appear) in Proc. of PAKDD 2018: 22nd Pacific-Asia Conference on Knowledge Discovery and Data Mining. 2018.

Diego Marron, Jesse Read, Albert Bifet, Eduard Ayguadé, José R. Herrero. 
link:"http://ieeexplore.ieee.org/document/8257930/"[Low-latency Multi-threaded Ensemble Learning for Dynamic Big Data Streams]. 
In Proc. of IEEE International Conference on Big Data (Big Data 2017). pp 223-232. 2017.

Diego Marron, Jesse Read, Albert Bifet, Talel Abdessalem, Eduard Ayguadé, José R. Herrero. 
link:http://proceedings.mlr.press/v63/Marron87.html[Echo State Hoeffding Tree Learning]. 
...
Yasemin Altun, Kamalika Das, Taneli Mielikäinen, Donato Malerba, Jerzy Stefanowski, Jesse Read, Marinka Žitnik, Michelangelo Ceci, Sašo Džeroski, editors. link:http://www.springer.com/us/book/9783319712727[European Conference, ECML PKDD 2017, Skopje, Macedonia, September 18--22, 2017, Proceedings, Part III]. _Machine Learning and Knowledge Discovery in Databases_. 2017.


//	Note that I have made that some of the published articles may be covered by copyright.
